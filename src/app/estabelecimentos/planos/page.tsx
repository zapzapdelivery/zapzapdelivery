    ...
    <div className={styles.container}>
      ...
      <main className={styles.mainContent}>
        <div className={styles.mobileOnly} style={{ marginBottom: '1rem', marginTop: '-0.5rem', padding: '0 1rem' }}>
          <Link href="/paineladmin" className={styles.backLink} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#6b7280', textDecoration: 'none', fontSize: '0.875rem' }}>
            <ArrowLeft size={18} />
            Voltar
          </Link>
        </div>
        ...
        <div className={styles.toolbar}>
          ...
          <div className={styles.actionButtons}>
            ...
            <Link href="/estabelecimentos/planos/novo" className={`${styles.btn} ${styles.btnNew}`}>
              <Plus size={18} />
               ...
               {filteredPlans.map((plan) => (
                 <div key={plan.id} className={styles.mobileCard}>
                   ...
                   <div className={styles.cardActions}>
                      ...
                      <div className={styles.mobileActionWrapper}>
                        <button className={`${styles.mobileActionBtn} ${styles.actionEdit}`}>
                          <Pencil size={20} />
                        </button>
