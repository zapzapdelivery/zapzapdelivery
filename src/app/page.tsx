                      ...
                      <tr key={order.id}>
                        ...
                        <td>
                          <div className={styles.clientInfo}>
                            <div className={styles.avatar} style={{ color: '#3b82f6', background: '#dbeafe' }}>{order.initials}</div>
                            <span>{order.client}</span>
                          </div>
                        </td>
                        <td className={styles.orderValue}>{order.value}</td>
                        <td>{order.time}</td>
                        <td>
                          <span className={`${styles.statusBadge} ${
                            order.status === 'Entregue' ? styles.statusSuccess :
                            order.status === 'Preparando' ? styles.statusWarning :
                            order.status === 'Enviado' ? styles.statusBlue :
                            styles.statusInfo
                          }`}>
                            {order.status}
                          </span>
                        ...
                        <td className={styles.actionCell}>
                          <button className={styles.iconButton} title="Ver detalhes">
